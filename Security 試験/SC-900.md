...
- セキュリティの概念を説明する
  - 一般的な脅威を説明する
  - 暗号化を説明する
- Microsoft セキュリティとコンプライアンスの原則を説明する
  - Microsoft の プライバシーの原則を説明する
  - サービス トラスト ポータルの提供内容を説明する
#### Microsoft ID とアクセス管理ソリューションの機能を説明する (25-30%)
- ID の原則/概念を定義する
  - ID を主要なセキュリティ境界として定義する
  - 認証を定義する
  - 承認を定義する
  - ID プロバイダーが何かを説明する
  - Active Directory が何かを説明する
...
- Microsoft 365 Defender (以前は Microsoft Threat Protection) を用いた脅威保護を説明する
...
- Microsoft 365 のセキュリティ管理機能を説明する
  - Microsoft 365 Security Center を説明する
...
- Microsoft 365 の内部リスク機能を説明する
  ...
  - 特権アクセス管理を説明する
  - 顧客のロックボックスを説明する
- Microsoft 365 の eDiscovery 機能を説明する
  - eDiscovery の目的を説明する
  - コンテンツ検索ツールの機能を説明する
  - コア eDiscovery ワークフローを説明する
  - 高度な eDisovery ワークフローを説明する
