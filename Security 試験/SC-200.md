...
### 試験の対象者
この試験では、次の技術タスクを達成する能力を測定します : Microsoft 365 Defender を使用して脅威を軽減します。Microsoft Defender for Cloud を使用して脅威を軽減します。Microsoft Sentinel を使用して脅威を軽減します。
...
この試験の受験者は、Microsoft Sentinel、Microsoft Defender for Cloud、Microsoft 365 Defender、およびサードパーティのセキュリティ製品を使用して、脅威を調査、対応、および探索した経験が必要となります。セキュリティ オペレーション アナリストとして、これらのテクノロジの構成とデプロイに関する知識も必要です。
(As an exam candidate, you should have experience investigating, responding to, and hunting for threats using Microsoft Sentinel, Microsoft Defender for Cloud, Microsoft 365 Defender, and third-party security products. As a security operations analyst, you should also have knowledge of configuring and vdeploying these technologies.)
...
(Identify and remediate security risks related to Azure AD Identity Protection events)
  - 条件付きアクセス イベントに関連するセキュリティ リスクを特定、修復する  
(Identify and remediate security risks related to conditional access events)
  - Azure Active Directory イベントに関連するセキュリティ リスクを特定、修復する  
...
(Investigate multi-workspace incidents)
  - Entity Behavior Analytics で高度な脅威を特定する  
