...
https://docs.microsoft.com/ja-jp/learn/paths/deploy-manage-identity-infrastructure/
- ハイブリッド環境で Windows Servers とワークロードを管理する - Learn | Microsoft Docs  
https://docs.microsoft.com/ja-jp/learn/paths/manage-windows-servers-workloads-hybrid-environment/
- ハイブリッド環境で仮想化とコンテナーを管理する - Learn | Microsoft Docs  
https://docs.microsoft.com/ja-jp/learn/paths/manage-virtualization-containers-hybrid-environment/
- Implement and operate an on-premises and hybrid networking infrastructure - Learn | Microsoft Docs  
https://docs.microsoft.com/ja-jp/learn/paths/implement-operate-premises-hybrid/
- Configure storage and file services - Learn | Microsoft Docs  
https://docs.microsoft.com/ja-jp/learn/paths/configure-storage-file-services/
