...
加えて、すべての Microsoft 365 ワークロードと Azure Active Directory の機能経験があり、これらの少なくとも 1 つを管理しています。また、ネットワーク、サーバー管理、DNS、および PowerShell に関する実践的な知識も持っている必要があります。
...
(Plan and implement device enrollment)
  - Azure Active Directory (Azure AD) へのデバイス参加またはハイブリッド参加を計画、実装する  
