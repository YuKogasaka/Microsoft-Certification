...
(Manage security and compliance settings for Microsoft Teams)
  ...
  - Microsoft Teams の条件付きアクセスを計画、構成する  
  (Plan and configure conditional access for Microsoft Teams)
  - 情報バリア ポリシーを計画、構成する  
...
(Plan and manage channels)
  ...
  - プライベート チャネルの Microsoft Teams ポリシーを作成、管理する  
...
(Manage phone numbers and services)
  ...
  - ユーザーやサイトに緊急ポリシーを割り当てる  
  (Assign an emergency policy to a user or a site)
  - ユーザーに緊急連絡先を割り当てる  
  (Assign an emergency address to a user)
