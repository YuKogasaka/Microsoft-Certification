...
### 試験の対象者
試験 AI-102 : Designing and Implementing a Microsoft Azure AI Solution の受験者は、Azure Cognitive Services、および Azure Applied AI サービスを活用する AI ソリューションを構築、管理、および展開の知識が必要となります。
...
- Language Understanding Service (LUIS) を用いて初期の言語モデルをビルドする
  ...
  - 複雑な階層エンティティを作成する
    - ロールの代わりに使用する
  - モデルをトレーニング、デプロイする
- Understanding を用いて、言語モデルを繰り返し、最適化する
  - フレーズ リストを実装する
  ...
  - データの不均衡を監視、修正する
  - パターンを実装する
- Language Unserstanding モデルを管理する
  - コラボレーターを管理する
  - バージョニングを管理する
